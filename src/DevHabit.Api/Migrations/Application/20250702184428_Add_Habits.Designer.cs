...
namespace DevHabit.Api.Migrations.Application
{
    ...
    [Migration("20250702184428_Add_Habits")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHabit.Api.Entity.Habit", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Api.Entity.Habit", b =>
                {
                    b.OwnsOne("DevHabit.Api.Entity.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("DevHabit.Api.Entity.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("DevHabit.Api.Entity.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
